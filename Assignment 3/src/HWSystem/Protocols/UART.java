 ...
 * reading and writing data using the UART protocol.
 * </p>
 */
public class UART implements Protocol {
    ...
    /**
     * Constructs a {@code UART} object with the specified file path and name.
     * <p>
     ...
     */
    public UART(String filePath, String fileName) {
    ...
    /**
     * Simulates reading data using the UART protocol.
     * <p>
    ...
    /**
     * Simulates writing data using the UART protocol.
     * <p>
    ...
    /**
     * Closes the UART communication and writes all stored messages to the file.
     * <p>
