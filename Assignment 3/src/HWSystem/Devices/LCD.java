...
public class LCD extends Display {
    ...
    /**
     * Turns on the LCD display and updates its state to {@code ON}.
     */
    @Override
    public void turnOn() {
    ...
    /**
     * Turns off the LCD display and updates its state to {@code OFF}.
     */
    @Override
    public void turnOff() {
    ...
    /**
     * Prints the given data on the LCD display.
     *
