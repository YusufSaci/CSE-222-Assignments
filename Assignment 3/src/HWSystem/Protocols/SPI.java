 ...
 * reading and writing data using the SPI protocol.
 * </p>
 */
public class SPI implements Protocol {
    ...
    /**
     * Constructs an {@code SPI} object with the specified file path and name.
     * <p>
     ...
     */
    public SPI(String filePath, String fileName) {
    ...
    /**
     * Simulates reading data using the SPI protocol.
     * <p>
    ...
    /**
     * Simulates writing data using the SPI protocol.
     * <p>
    ...
    /**
     * Closes the SPI communication and writes all stored messages to the file.
     * <p>
